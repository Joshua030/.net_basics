...
namespace Infrastructure
{
    public static class Startup
    {
        ...
        {
            // Implementation for adding identity services
            ...
            services.
                ...
                .AddJwtBearer(bearer =>
                {
                    ...
                    bearer.Events = new JwtBearerEvents
                    {
                        ...
                        {
                            if (context.Exception is SecurityTokenException or ArgumentException)
                            {
                                if (!context.Response.HasStarted)
                                {
                                    ...
                                    var result = JsonConvert.SerializeObject(ResponseWrapper.Fail("Authentication failed. Token is invalid or expired."));
                            ...
                            else
                            {
                                if (!context.Response.HasStarted)
                                {
                                    ...
                                    var result = JsonConvert.SerializeObject(ResponseWrapper.Fail("An unhandled error has ocurred."));
                                    return context.Response.WriteAsync(result);
                                }
                                return Task.CompletedTask;
                            }
        ...
        internal static IServiceCollection AddOpenApiDocumentation(this IServiceCollection services, IConfiguration config)
        {
            ...
            _ = services.AddOpenApiDocument((document, serviceProvider) =>
            {
                ...
                {
                    Name = "Authorization",
                    Description = "Enter your Bearer token to attach it as header on your request",
        ...
        public static IApplicationBuilder UseInfrastructure(this IApplicationBuilder app)
        {
            return app
                ...
                .UseMultiTenant()
                .UseAuthorization()
                .UseOpenApiDocumenation()
                ;
        }

        internal static IApplicationBuilder UseOpenApiDocumenation(this IApplicationBuilder app)
        {
            app.UseOpenApi();
