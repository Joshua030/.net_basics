    ...
    public class TenantDbSeeder : ITenantDbSeeder
    {
        ...
        public async Task InitializeDatabaseAsync(CancellationToken cancellationToken)
        {
            ...
            foreach (var tenant in await _tenantDbContext.TenantInfo.ToListAsync(cancellationToken))
            {
                ...
                // Seed Application Data for each tenant
        ...
        {
            // Implementation for initializing database with tenant data
        ...
        {
            // Implementation for initializing application database for a specific tenant
